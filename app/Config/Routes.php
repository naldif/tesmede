...
$routes->setDefaultController('Komoditas');
...
$routes->get('/', 'Komoditas::index');

$routes->post('/komoditas/store', 'Komoditas::store');
$routes->get('komoditas/edit/(:num)', 'Komoditas::edit/$1');
$routes->post('komoditas/update/(:num)', 'Komoditas::update/$1');
$routes->get('komoditas/delete/(:num)', 'Komoditas::delete/$1');
$routes->get('komoditas/detail/(:num)', 'Komoditas::detail/$1');
